...
part of 'invited_challenges_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<InvitedChallengesRecord> _$invitedChallengesRecordSerializer =
    new _$InvitedChallengesRecordSerializer();

class _$InvitedChallengesRecordSerializer
    implements StructuredSerializer<InvitedChallengesRecord> {
  @override
  ...
  @override
  final String wireName = 'InvitedChallengesRecord';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, InvitedChallengesRecord object,
  ...
  @override
  InvitedChallengesRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new InvitedChallengesRecordBuilder();
...
class _$InvitedChallengesRecord extends InvitedChallengesRecord {
  @override
  final String? title;
  @override
  ...
  factory _$InvitedChallengesRecord(
          [void Function(InvitedChallengesRecordBuilder)? updates]) =>
      (new InvitedChallengesRecordBuilder()..update(updates))._build();

  _$InvitedChallengesRecord._(
      {this.title,
      this.details,
      this.createdAt,
      this.createBy,
  ...
  @override
  InvitedChallengesRecord rebuild(
          void Function(InvitedChallengesRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  InvitedChallengesRecordBuilder toBuilder() =>
      new InvitedChallengesRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is InvitedChallengesRecord &&
        title == other.title &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'InvitedChallengesRecord')
          ..add('title', title)
          ..add('details', details)
...
class InvitedChallengesRecordBuilder
    implements
        Builder<InvitedChallengesRecord, InvitedChallengesRecordBuilder> {
  _$InvitedChallengesRecord? _$v;
  ...
  InvitedChallengesRecordBuilder() {
    InvitedChallengesRecord._initializeBuilder(this);
  }

  InvitedChallengesRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _title = $v.title;
      _details = $v.details;
  ...
  @override
  void replace(InvitedChallengesRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$InvitedChallengesRecord;
  }

  @override
  void update(void Function(InvitedChallengesRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  InvitedChallengesRecord build() => _build();

  _$InvitedChallengesRecord _build() {
    _$InvitedChallengesRecord _$result;
    try {
      _$result = _$v ??
          new _$InvitedChallengesRecord._(
              title: title,
              details: details,
              createdAt: createdAt,
              createBy: createBy,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'InvitedChallengesRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
