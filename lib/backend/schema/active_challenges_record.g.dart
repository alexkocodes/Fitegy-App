...
part of 'active_challenges_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<ActiveChallengesRecord> _$activeChallengesRecordSerializer =
    new _$ActiveChallengesRecordSerializer();

class _$ActiveChallengesRecordSerializer
    implements StructuredSerializer<ActiveChallengesRecord> {
  @override
  ...
  @override
  final String wireName = 'ActiveChallengesRecord';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, ActiveChallengesRecord object,
  ...
  @override
  ActiveChallengesRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new ActiveChallengesRecordBuilder();
...
class _$ActiveChallengesRecord extends ActiveChallengesRecord {
  @override
  final String? title;
  @override
  ...
  factory _$ActiveChallengesRecord(
          [void Function(ActiveChallengesRecordBuilder)? updates]) =>
      (new ActiveChallengesRecordBuilder()..update(updates))._build();

  _$ActiveChallengesRecord._(
      {this.title,
      this.details,
      this.createdAt,
      this.createBy,
  ...
  @override
  ActiveChallengesRecord rebuild(
          void Function(ActiveChallengesRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  ActiveChallengesRecordBuilder toBuilder() =>
      new ActiveChallengesRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is ActiveChallengesRecord &&
        title == other.title &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'ActiveChallengesRecord')
          ..add('title', title)
          ..add('details', details)
...
class ActiveChallengesRecordBuilder
    implements Builder<ActiveChallengesRecord, ActiveChallengesRecordBuilder> {
  _$ActiveChallengesRecord? _$v;
  ...
  ActiveChallengesRecordBuilder() {
    ActiveChallengesRecord._initializeBuilder(this);
  }

  ActiveChallengesRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _title = $v.title;
      _details = $v.details;
  ...
  @override
  void replace(ActiveChallengesRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$ActiveChallengesRecord;
  }

  @override
  void update(void Function(ActiveChallengesRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  ActiveChallengesRecord build() => _build();

  _$ActiveChallengesRecord _build() {
    _$ActiveChallengesRecord _$result;
    try {
      _$result = _$v ??
          new _$ActiveChallengesRecord._(
              title: title,
              details: details,
              createdAt: createdAt,
              createBy: createBy,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'ActiveChallengesRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
