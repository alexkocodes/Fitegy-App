...
class EditProfilesWidget extends StatefulWidget {
  const EditProfilesWidget({Key? key}) : super(key: key);
...
class _EditProfilesWidgetState extends State<EditProfilesWidget> {
  ...
  void initState() {
    ...
    _model.yourEmojiController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.emoji, ''));
  }
            ...
            Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => TextFormField(
                  ...
                  maxLines: 3,
                  validator:
                      _model.yourBioControllerValidator.asValidator(context),
                ),
              ),
            ),
            Padding(
              ...
              child: AuthUserStreamWidget(
                builder: (context) => TextFormField(
                  ...
                  maxLines: null,
                  validator:
                      _model.yourEmojiControllerValidator.asValidator(context),
                ),
              ),
            ),
            Padding(
              ...
              child: Container(
                ...
                child: AuthUserStreamWidget(
                  builder: (context) => ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      imageUrl:
                          valueOrDefault(currentUserDocument?.bannerUrl, ''),
            ...
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  ...
                  final usersUpdateData = createUsersRecordData(
                    bannerUrl: _model.uploadedFileUrl1,
                  );
                  await currentUserReference!.update(usersUpdateData);
                },
                text: 'Change Banner',
